...
For the clean Ubuntu WSL no-hardware workflow, use these three files first:
...
- [Script flow deep dive](docs/summary_script_flow.md)

Additional reference notes from earlier iterations:

- Archived notes are available under [docs/archive](docs/archive).
